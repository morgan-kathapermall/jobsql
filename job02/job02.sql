...
--
-- Hôte : localhost
-- Généré le :  mar. 08 déc. 2020 à 17:07
...
INSERT INTO `etage` (`id`, `nom_etage`, `numero`, `superficie`) VALUES
(1, 'RDC', 0, 500),
(2, 'R+1', 1, 500);
...
INSERT INTO `salles` (`id`, `nom_salle`, `id_etage`, `capacite`) VALUES
(1, 'Lounge', 1, 100),
(2, 'Studio Son', 1, 5),
(3, 'Broadcasting', 2, 50),
(4, 'Bocal Peda', 2, 4),
...
--
ALTER TABLE `salles`
  ADD CONSTRAINT `salle_etage` FOREIGN KEY (`id_etage`) REFERENCES `etage` (`id`);
COMMIT;
